## This is a script to simulate fish evolutionary and population dynamics.
## the main features of the simulation are outlined in
## ~/Dropbox/CSIRO/Simulations/Thinking through the simulation.Rmd.

## Section 1: initialise
## produce founders, set up data matrices for individuals and (possibly) genotypes
...
## Sampling from the closed sim happens in a separate function
## The sim can be re-started from a (subsetted) closed-sim data matrix

## Genotyping (and its associated error) should occur after sampling.
