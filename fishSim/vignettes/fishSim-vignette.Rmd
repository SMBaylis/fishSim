...
```{r}
## mark 100 individuals alive at the end of the simulation as 'captured'.
indiv <- capture(indiv, n = 100, year = 60, fatal = FALSE) 
...
for (k in 1:60) {
    ...
    if(k %in% c(10,20,30,40,50,60)) {
	    indiv <- capture(indiv, n = 20, fatal = TRUE, year = k)
